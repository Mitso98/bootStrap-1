!function() {
    ...
    function() {
        ...
        return t.init = function(e, t, i) {
            ...
            e.hasAttribute("data-srcset") && o.setAttribute("data-srcset", e.getAttribute("data-srcset")),
            n.appendChild(o),
            this.userSettings.captions && ("function" == typeof this.userSettings.captionText ? r.textContent = this.userSettings.captionText(e) : "self" === this.userSettings.captionsSelector && e.getAttribute(this.userSettings.captionAttribute) ? r.textContent = e.getAttribute(this.userSettings.captionAttribute) : "img" === this.userSettings.captionsSelector && a && a.getAttribute(this.userSettings.captionAttribute) && (r.textContent = a.getAttribute(this.userSettings.captionAttribute)),
            r.textContent && (r.id = "tobii-figcaption-" + this.figcaptionId,
            n.appendChild(r),
            ...
            s.setAttribute("aria-label", this.userSettings.loadingIndicatorLabel),
            t.appendChild(s),
    ...
    function() {
        ...
        return t.init = function(e, t, i) {
            ...
            e.hasAttribute("data-width") && t.setAttribute("data-width", "" + e.getAttribute("data-width")),
            e.hasAttribute("data-height") && t.setAttribute("data-height", "" + e.getAttribute("data-height")),
        ...
        t.onLoad = function(e) {
            ...
            null == t) {
                ...
                n.indexOf("youtube.com") > -1 ? t.setAttribute("allow", "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture") : n.indexOf("vimeo.com") > -1 ? t.setAttribute("allow", "autoplay; picture-in-picture") : e.hasAttribute("data-allow") && t.setAttribute("allow", e.getAttribute("data-allow")),
                ...
                t.setAttribute("src", e.getAttribute("data-href"))
        }
        ,
        t.onLeave = function(e) {}
        ,
    ...
    function() {
        ...
        return t.init = function(e, t, i) {
            ...
            if (!r)
                throw new Error("Ups, I can't find the target " + n + ".");
            t.appendChild(r),
        ...
        t.onLoad = function(e) {
            ...
            t && (t.hasAttribute("data-time") && t.readyState > 0 && (t.currentTime = t.getAttribute("data-time")),
    ...
    function a(e) {
        var s = {
          ...
          , C = null
          , T = function(e) {
            if (null === document.querySelector('[data-type="youtube"]') || _)
                N(e);
            else {
          ...
          , N = function(e) {
            if (S = P(e),
            Object.prototype.hasOwnProperty.call(I, S) || (I[S] = JSON.parse(JSON.stringify(c)),
            Y()),
            -1 !== I[S].gallery.indexOf(e))
                throw new Error("Ups, element already added.");
            if (I[S].gallery.push(e),
            I[S].elementsLength++,
            l.zoom && e.querySelector("img") && "false" !== e.getAttribute("data-zoom") || "true" === e.getAttribute("data-zoom")) {
          ...
          , k = function(e) {
            ...
            return void 0 !== s[t] ? s[t] : (e.hasAttribute("data-type") && console.log("Unknown lightbox element type: " + t),
            s.image)
        }
          , U = function(e) {
            if (C = null !== C ? C : S,
          ...
          , X = function() {
            ...
            se(),
            null !== window.history.state && "close" === window.history.state.tobii && window.history.back(),
            A.focus(),
            B(I[C].currentIndex),
            V(I[C].currentIndex),
          ...
          , M = function() {
            ...
            I[C].currentIndex > 0 && (B(I[C].currentIndex),
            R(--I[C].currentIndex),
            le("left"),
          ...
          , H = function() {
            if (!ce())
                throw new Error("Ups, I'm closed.");
            I[C].currentIndex < I[C].elementsLength - 1 && (B(I[C].currentIndex),
            R(++I[C].currentIndex),
            le("right"),
            V(I[C].currentIndex - 1),
            z(I[C].currentIndex + 1));
          ...
          , j = function() {
            I[C = null !== C ? C : S].slider.style.transform = "translate3d(" + (E = -I[C].currentIndex * p.offsetWidth) + "px, 0, 0)",
            L = E
        }
          , W = function() {
            g = {
          ...
          , K = function(e) {
            e.target === b ? M() : e.target === h ? H() : (e.target === f || !1 === v && !1 === y && e.target.classList.contains("tobii__slide") && l.docClose) && X(),
            e.stopPropagation()
        }
          , Q = function(e) {
            ...
            9 === e.keyCode || "Tab" === e.code ? e.shiftKey && 0 === i ? (t[t.length - 1].focus(),
            e.preventDefault()) : e.shiftKey || i !== t.length - 1 || (t[0].focus(),
            e.preventDefault()) : 27 === e.keyCode || "Escape" === e.code ? (e.preventDefault(),
            X()) : 37 === e.keyCode || "ArrowLeft" === e.code ? (e.preventDefault(),
            M()) : 39 !== e.keyCode && "ArrowRight" !== e.code || (e.preventDefault(),
            H())
        }
          , Z = function(e) {
            be(e.target) || (e.stopPropagation(),
            v = !1,
            y = !1,
            w = !0,
          ...
          , oe = function() {
            Math.abs(g.startX - g.endX) > 0 && !y && I[C].elementsLength > 1 ? (I[C].slider.style.transform = "translate3d(" + (L - Math.round(g.startX - g.endX)) + "px, 0, 0)",
            v = !0,
            y = !1) : Math.abs(g.startY - g.endY) > 0 && !v && l.swipeClose && (I[C].slider.style.transform = "translate3d(" + L + "px, -" + Math.round(g.startY - g.endY) + "px, 0)",
            v = !1,
            y = !0)
        }
          , ae = function() {
            ...
            l.draggable && pe() && (p.addEventListener("touchstart", Z),
          ...
          , se = function() {
            ...
            l.draggable && pe() && (p.removeEventListener("touchstart", Z),
          ...
          , de = function() {
            (l.draggable && l.swipeClose && pe() && !I[C].slider.classList.contains("tobii__slider--is-draggable") || l.draggable && I[C].elementsLength > 1 && !I[C].slider.classList.contains("tobii__slider--is-draggable")) && I[C].slider.classList.add("tobii__slider--is-draggable"),
            !l.nav || 1 === I[C].elementsLength || "auto" === l.nav && pe() ? (b.setAttribute("aria-hidden", "true"),
            b.disabled = !0,
            h.setAttribute("aria-hidden", "true"),
            h.disabled = !0) : (b.setAttribute("aria-hidden", "false"),
            b.disabled = !1,
            h.setAttribute("aria-hidden", "false"),
            h.disabled = !1),
            m.setAttribute("aria-hidden", l.counter && 1 !== I[C].elementsLength ? "false" : "true")
        }
          , le = function(e) {
            j(),
            m.textContent = I[C].currentIndex + 1 + "/" + I[C].elementsLength,
            function(e) {
                (!0 === l.nav || "auto" === l.nav) && !pe() && I[C].elementsLength > 1 ? (b.setAttribute("aria-hidden", "true"),
                b.disabled = !0,
                h.setAttribute("aria-hidden", "true"),
                h.disabled = !0,
                1 === I[C].elementsLength ? l.close && f.focus() : 0 === I[C].currentIndex ? (h.setAttribute("aria-hidden", "false"),
                h.disabled = !1,
                h.focus()) : I[C].currentIndex === I[C].elementsLength - 1 ? (b.setAttribute("aria-hidden", "false"),
                b.disabled = !1,
                b.focus()) : (b.setAttribute("aria-hidden", "false"),
                b.disabled = !1,
                h.setAttribute("aria-hidden", "false"),
                h.disabled = !1,
                "left" === e ? b.focus() : h.focus())) : l.close && f.focus()
            }(e)
        }
          , ue = function() {
            ce() && X();
        ...
        return function(e) {
            if (document.querySelector("div.tobii"))
                ...
                if (!i)
                    throw new Error("Ups, I can't find the selector " + l.selector + " on this website.");
                var n = [];
                i.forEach(function(e) {
                    ...
                    void 0 !== n[i += "__" + t] ? e.addEventListener("click", function(e) {
                        D(t),
                        U(),
                        e.preventDefault()
                    }) : (n[i] = 1,
